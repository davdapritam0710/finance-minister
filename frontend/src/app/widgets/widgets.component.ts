...
@Component({
    ...
    imports: [
        ...
        TimeSpendingsComponent,
        AverageEnrollmentRateComponent,
        TodaysCourseComponent,
        SlaMonitoringComponent,
        TicketsSolvedAndCleatedComponent,
        PerformanceOfAgentsComponent,
        TicketsByChannelComponent,
